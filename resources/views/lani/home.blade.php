...
@if(Session::get('UserMember') == "Joining")
 <div class="alert alert-success alert-dismissible fade show" role="alert" style="margin: 0px; padding: 30px; font-size: 30px">
  <strong>Welcome {{ $get_data['scholarInfo']['username'] }} <i class="fas fa-user-graduate"></i></strong> 
...
<div style="text-align: center;">
  <br>
<h2>Thank you for registering on our scholarship program, please wait for the admin confirmation</h2>
<br>
<h4>Registration Application</h4>
<br>
<p>First Name : <b>{{  $get_data['scholarInfo']['scholarFirstName'] }}</b></p>
<p>Last Name : <b>{{  $get_data['scholarInfo']['scholarLastName'] }}</b></p>
<p>Middle Name : <b>{{  $get_data['scholarInfo']['scholarMiddleName'] }}</b></p>
<p>Suffix : <b>{{  $get_data['scholarInfo']['scholarSuffix'] }}</b></p>
<p>Age : <b>{{  $get_data['scholarInfo']['scholarAge'] }}</b></p>
<p>Gender : <b>{{  $get_data['scholarInfo']['scholarGender'] }}</b></p>
<p>Email : <b>{{  $get_data['scholarInfo']['scholarEmail'] }}</b></p>
<p>Contact No. : <b>{{  $get_data['scholarInfo']['scholarContactNum'] }}</b></p>
<p>Religion : <b>{{  $get_data['scholarInfo']['scholarReligion'] }}</b></p>
<p>Birthday : <b>{{  $get_data['scholarInfo']['scholarBirthDate'] }}</b></p>
<p>Birthplace : <b>{{  $get_data['scholarInfo']['scholarBirthPlace'] }}</b></p>
<p>Civil Status : <b>{{  $get_data['scholarInfo']['scholarCivilStatus'] }}</b></p>
<p>Address : <b>{{  $get_data['scholarInfo']['scholarAddress'] }}</b></p>
<p>Barangay: <b>{{  $get_data['scholarInfo']['scholarBarangay'] }}</b></p>
<p>District : <b>{{  $get_data['scholarInfo']['scholarDistrict'] }}</b></p>
<p>City : <b>{{  $get_data['scholarInfo']['scholarCity'] }}</b></p>
<p>Year started residing in Taguig City : <b>{{  $get_data['scholarInfo']['scholarStartedDate'] }}</b></p>

</div>
@elseif(Session::get('UserMember') == "banned")
<br>
<h2>The main admin banned you in scholars list, please conctect the main admin for more detail.</h2>
@else
       ...
       <div class="intro">
        ...
        @endphp
          ...
          @if(count($announcements) > 3)
           <div class="col-sm-6 col-md-4 item">
                <a href="{{ route('scholarAnnounce') }}"  class="badge badge-danger">See more announcements</a>
            </div>
          @endif
        </div>
    </div>
