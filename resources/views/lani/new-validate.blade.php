            ...
            <div class="col">
                ...
                <div class="row text-center">
                    <div class="col-xl-12 text-center">
                        ...
                        <label class="btn btn-outline-success" style="font-size: 30px;">ACCEPTED<input type="radio" id="btnradio1" name="entriesStatus" value="accepted" 
                            <?php if(count($errors)>0 && old('entriesStatus') == "accepted") {echo 'checked="checked"';} 
                  if(@$entry->entriesStatus == "accepted" && count($errors) == 0){echo 'checked="checked"';} ?> 
                            ></label>


                        <label class="btn btn-outline-primary" style="font-size: 30px;">RESOLVE<input type="radio" id="btnradio-2" name="entriesStatus" value="resolve"  <?php if(count($errors)>0 && old('entriesStatus') == "resolve") {echo 'checked="checked"';} 
                  if(@$entry->entriesStatus == "resolve" && count($errors) == 0){echo 'checked="checked"';} ?>></label>


                        <label class="btn btn-outline-dark" style="font-size: 30px;">REJECTED<input type="radio" id="btnradio-3" name="entriesStatus" value="rejected" 
                  <?php if(count($errors)>0 && old('entriesStatus') == "rejected") {echo 'checked="checked"';} 
                  if(@$entry->entriesStatus == "rejected" && count($errors) == 0){echo 'checked="checked"';} ?>></label>
                    </div>
                ...
                <div class="row" style="margin-top: 25px;">
                    ...
                    <div class="col"><textarea class="form-control-lg" name="entriesComment">
                        <?php if (count($errors)>0){
                 echo old('entriesComment');
                }
                else{ 
                echo $entry->entriesComment;
                }?>
                    {{ old('entriesComment') }}</textarea>
